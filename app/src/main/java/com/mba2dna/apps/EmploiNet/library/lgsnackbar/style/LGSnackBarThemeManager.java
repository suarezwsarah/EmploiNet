package com.mba2dna.apps.EmploiNet.library.lgsnackbar.style;
...
import com.mba2dna.apps.EmploiNet.library.lgsnackbar.style.*;
import com.mba2dna.apps.EmploiNet.library.lgsnackbar.style.LGSnackBarTheme;

import static com.mba2dna.apps.EmploiNet.library.lgsnackbar.style.LGSnackBarThemeManager.LGSnackbarThemeName.MATERIAL;
...
public class LGSnackBarThemeManager {
    ...
    public static LGSnackBarTheme getTheme(Context context, LGSnackbarThemeName themeName) {
        if (themeName==null){
            themeName = LGSnackbarThemeName.MATERIAL;
        }
        switch (themeName) {
            case MATERIAL:
