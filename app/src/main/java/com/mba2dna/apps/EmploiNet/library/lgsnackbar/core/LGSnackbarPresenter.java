package com.mba2dna.apps.EmploiNet.library.lgsnackbar.core;
...
import com.mba2dna.apps.EmploiNet.library.lgsnackbar.core.*;
import com.mba2dna.apps.EmploiNet.library.lgsnackbar.core.LGSnackbarAction;
import com.mba2dna.apps.EmploiNet.utils.CommonUtils;

import static com.mba2dna.apps.EmploiNet.library.lgsnackbar.LGSnackbarManager.NO_ICON_ID;
...
class LGSnackbarPresenter {
    ...
    private com.mba2dna.apps.EmploiNet.library.lgsnackbar.core.LGSnackbar lgSnackbar;

    public LGSnackbarPresenter(@NonNull com.mba2dna.apps.EmploiNet.library.lgsnackbar.core.LGSnackbar lgSnackbar,Context context) {
    ...
    private void onSnackbarContainerAttached(final View rootView, final CoordinatorLayout snackbarContainer) {
        ...
        CommonUtils.setRobotoBoldFont(context,textView);
