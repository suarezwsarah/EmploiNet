package com.mba2dna.apps.EmploiNet.library.simpledialog;
...
public class SimpleDialog extends Dialog implements View.OnClickListener {
    ...
    private void setTitle(String message) {
        ...
        CommonUtils.setRobotoBoldFont(getContext(),txtTitle);
    }
    ...
    private void setContent(String message, Integer paddingLeft) {
        ...
        CommonUtils.setRobotoThinFont(getContext(),txtContent);
    }
    ...
    private void setBtnPermanentCheck() {
        ...
        CommonUtils.setRobotoBoldFont(getContext(),txtPermanent);
    }
    ...
    private void setBtnConfirm() {
        ...
        CommonUtils.setRobotoBoldFont(getContext(),txtConfirm);
    }
    ...
    private void setBtnCancel() {
        ...
        CommonUtils.setRobotoBoldFont(getContext(),txtCancel);
    }
